import "../../styles/components/quote-box.css"
...
const QuoteBox = () => {
    return (
        ...
        <div className="support-card">
            <div className="support-card-name">We are hoping to be helpful</div>
            <div className="quote">
            ...
            <div className="body-text">Your feedback is so valuable for us.</div>
            <div className="author">- in your service<br></br> 
